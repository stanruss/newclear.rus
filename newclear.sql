...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Мар 31 2017 г., 16:28
...
--
-- База данных: `newclear`
--

-- --------------------------------------------------------

--
-- Структура таблицы `new_access_actiondom`
--

CREATE TABLE `new_access_actiondom` (
...
--
-- Структура таблицы `new_access_actions`
--

CREATE TABLE `new_access_actions` (
  `id` int(10) UNSIGNED NOT NULL,
  `target` varchar(100) NOT NULL DEFAULT '',
  `principal_class` varchar(100) NOT NULL DEFAULT 'modPrincipal',
  `principal` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `new_access_category`
--

CREATE TABLE `new_access_category` (
  `id` int(10) UNSIGNED NOT NULL,
  `target` varchar(100) NOT NULL DEFAULT '',
  `principal_class` varchar(100) NOT NULL DEFAULT 'modPrincipal',
  `principal` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `new_access_context`
--

CREATE TABLE `new_access_context` (
  `id` int(10) UNSIGNED NOT NULL,
  `target` varchar(100) NOT NULL DEFAULT '',
  `principal_class` varchar(100) NOT NULL DEFAULT 'modPrincipal',
  `principal` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Дамп данных таблицы `new_access_context`
--

INSERT INTO `new_access_context` (`id`, `target`, `principal_class`, `principal`, `authority`, `policy`) VALUES
...
--
-- Структура таблицы `new_access_elements`
--

CREATE TABLE `new_access_elements` (
  `id` int(10) UNSIGNED NOT NULL,
  `target` varchar(100) NOT NULL DEFAULT '',
  `principal_class` varchar(100) NOT NULL DEFAULT 'modPrincipal',
  `principal` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `new_access_media_source`
--

CREATE TABLE `new_access_media_source` (
  `id` int(10) UNSIGNED NOT NULL,
  `target` varchar(100) NOT NULL DEFAULT '',
  `principal_class` varchar(100) NOT NULL DEFAULT 'modPrincipal',
  `principal` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `new_access_menus`
--

CREATE TABLE `new_access_menus` (
  `id` int(10) UNSIGNED NOT NULL,
  `target` varchar(100) NOT NULL DEFAULT '',
  `principal_class` varchar(100) NOT NULL DEFAULT 'modPrincipal',
  `principal` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `new_access_namespace`
--

CREATE TABLE `new_access_namespace` (
  `id` int(10) UNSIGNED NOT NULL,
  `target` varchar(100) NOT NULL DEFAULT '',
  `principal_class` varchar(100) NOT NULL DEFAULT 'modPrincipal',
  `principal` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `new_access_permissions`
--
...
--
-- Дамп данных таблицы `new_access_permissions`
--

INSERT INTO `new_access_permissions` (`id`, `template`, `name`, `description`, `value`) VALUES
...
--
-- Структура таблицы `new_access_policies`
--
...
--
-- Дамп данных таблицы `new_access_policies`
--
...
--
-- Структура таблицы `new_access_policy_templates`
--
...
--
-- Дамп данных таблицы `new_access_policy_templates`
--

INSERT INTO `new_access_policy_templates` (`id`, `template_group`, `name`, `description`, `lexicon`) VALUES
...
--
-- Структура таблицы `new_access_policy_template_groups`
--
...
--
-- Дамп данных таблицы `new_access_policy_template_groups`
--

INSERT INTO `new_access_policy_template_groups` (`id`, `name`, `description`) VALUES
...
--
-- Структура таблицы `new_access_resources`
--

CREATE TABLE `new_access_resources` (
  `id` int(10) UNSIGNED NOT NULL,
  `target` varchar(100) NOT NULL DEFAULT '',
  `principal_class` varchar(100) NOT NULL DEFAULT 'modPrincipal',
  `principal` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `new_access_resource_groups`
--

CREATE TABLE `new_access_resource_groups` (
  `id` int(10) UNSIGNED NOT NULL,
  `target` varchar(100) NOT NULL DEFAULT '',
  `principal_class` varchar(100) NOT NULL DEFAULT 'modPrincipal',
  `principal` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `new_access_templatevars`
--

CREATE TABLE `new_access_templatevars` (
  `id` int(10) UNSIGNED NOT NULL,
  `target` varchar(100) NOT NULL DEFAULT '',
  `principal_class` varchar(100) NOT NULL DEFAULT 'modPrincipal',
  `principal` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `new_actiondom`
--
...
--
-- Структура таблицы `new_actions_fields`
--

CREATE TABLE `new_actions_fields` (
  `id` int(10) UNSIGNED NOT NULL,
  `action` varchar(255) NOT NULL DEFAULT '',
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Дамп данных таблицы `new_actions_fields`
--
...
--
-- Структура таблицы `new_active_users`
--
...
--
-- Структура таблицы `new_categories_closure`
--
...
--
-- Структура таблицы `new_class_map`
--

CREATE TABLE `new_class_map` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Дамп данных таблицы `new_class_map`
--

INSERT INTO `new_class_map` (`id`, `class`, `parent_class`, `name_field`, `path`, `lexicon`) VALUES
...
--
-- Структура таблицы `new_content_type`
--
...
--
-- Дамп данных таблицы `new_content_type`
--

INSERT INTO `new_content_type` (`id`, `name`, `description`, `mime_type`, `file_extensions`, `headers`, `binary`) VALUES
...
--
-- Дамп данных таблицы `new_context`
--

INSERT INTO `new_context` (`key`, `name`, `description`, `rank`) VALUES
...
--
-- Структура таблицы `new_context_resource`
--

CREATE TABLE `new_context_resource` (
...
--
-- Структура таблицы `new_context_setting`
--
...
--
-- Дамп данных таблицы `new_context_setting`
--

INSERT INTO `new_context_setting` (`context_key`, `key`, `value`, `xtype`, `namespace`, `area`, `editedon`) VALUES
...
--
-- Структура таблицы `new_dashboard`
--
...
--
-- Дамп данных таблицы `new_dashboard`
--

INSERT INTO `new_dashboard` (`id`, `name`, `description`, `hide_trees`) VALUES
(1, 'Default', '', 0);

-- --------------------------------------------------------

--
-- Структура таблицы `new_dashboard_widget`
--
...
--
-- Дамп данных таблицы `new_dashboard_widget`
--

INSERT INTO `new_dashboard_widget` (`id`, `name`, `description`, `type`, `content`, `namespace`, `lexicon`, `size`) VALUES
...
--
-- Структура таблицы `new_dashboard_widget_placement`
--
...
--
-- Дамп данных таблицы `new_dashboard_widget_placement`
--

INSERT INTO `new_dashboard_widget_placement` (`dashboard`, `widget`, `rank`) VALUES
(1, 5, 0),
(1, 1, 1),
(1, 2, 2),
(1, 3, 3),
...
--
-- Структура таблицы `new_documentgroup_names`
--
...
--
-- Структура таблицы `new_document_groups`
--
...
--
-- Структура таблицы `new_element_property_sets`
--
...
--
-- Структура таблицы `new_extension_packages`
--

CREATE TABLE `new_extension_packages` (
  `id` int(10) UNSIGNED NOT NULL,
  `namespace` varchar(40) NOT NULL DEFAULT 'core',
...
--
-- Структура таблицы `new_fc_profiles`
--

CREATE TABLE `new_fc_profiles` (
  `id` int(10) UNSIGNED NOT NULL,
  `name` varchar(255) NOT NULL DEFAULT '',
  `description` text NOT NULL,
...
--
-- Структура таблицы `new_fc_profiles_usergroups`
--
...
--
-- Структура таблицы `new_lexicon_entries`
--

CREATE TABLE `new_lexicon_entries` (
  `id` int(10) UNSIGNED NOT NULL,
  `name` varchar(255) NOT NULL DEFAULT '',
  `value` text NOT NULL,
...
--
-- Структура таблицы `new_manager_log`
--
...
(1, 1, '2017-03-31 16:25:35', 'login', 'modContext', 'mgr');

-- --------------------------------------------------------

--
-- Структура таблицы `new_media_sources`
--
...
--
-- Дамп данных таблицы `new_media_sources`
--
...
--
-- Структура таблицы `new_media_sources_contexts`
--
...
--
-- Структура таблицы `new_media_sources_elements`
--
...
--
-- Структура таблицы `new_membergroup_names`
--
...
--
-- Дамп данных таблицы `new_membergroup_names`
--
...
--
-- Структура таблицы `new_member_groups`
--
...
--
-- Дамп данных таблицы `new_member_groups`
--
...
--
-- Дамп данных таблицы `new_menus`
--

INSERT INTO `new_menus` (`text`, `parent`, `action`, `description`, `icon`, `menuindex`, `params`, `handler`, `permissions`, `namespace`) VALUES
...
--
-- Структура таблицы `new_namespaces`
--
...
--
-- Дамп данных таблицы `new_namespaces`
--

INSERT INTO `new_namespaces` (`name`, `path`, `assets_path`) VALUES
('core', '{core_path}', '{assets_path}');

-- --------------------------------------------------------

--
-- Структура таблицы `new_property_set`
--
...
--
-- Структура таблицы `new_register_messages`
--

CREATE TABLE `new_register_messages` (
...
--
-- Структура таблицы `new_register_queues`
--
...
--
-- Дамп данных таблицы `new_register_queues`
--

INSERT INTO `new_register_queues` (`id`, `name`, `options`) VALUES
(1, 'locks', 'a:1:{s:9:\"directory\";s:5:\"locks\";}');

-- --------------------------------------------------------

--
-- Структура таблицы `new_register_topics`
--

CREATE TABLE `new_register_topics` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Дамп данных таблицы `new_session`
--

INSERT INTO `new_session` (`id`, `access`, `data`) VALUES
('dua06mtr54h7pq0359sstl7u85', 1490966771, 'modx.user.contextTokens|a:0:{}');

-- --------------------------------------------------------

--
-- Структура таблицы `new_site_content`
--

CREATE TABLE `new_site_content` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Структура таблицы `new_site_plugins`
--
...
--
-- Структура таблицы `new_site_plugin_events`
--
...
--
-- Структура таблицы `new_site_snippets`
--
...
--
-- Структура таблицы `new_site_templates`
--
...
--
-- Дамп данных таблицы `new_site_templates`
--
...
--
-- Структура таблицы `new_site_tmplvars`
--
...
--
-- Структура таблицы `new_site_tmplvar_access`
--
...
--
-- Структура таблицы `new_site_tmplvar_contentvalues`
--
...
--
-- Структура таблицы `new_site_tmplvar_templates`
--
...
--
-- Структура таблицы `new_system_eventnames`
--
...
--
-- Дамп данных таблицы `new_system_eventnames`
--

INSERT INTO `new_system_eventnames` (`name`, `service`, `groupname`) VALUES
...
--
-- Структура таблицы `new_system_settings`
--
...
--
-- Дамп данных таблицы `new_system_settings`
--

INSERT INTO `new_system_settings` (`key`, `value`, `xtype`, `namespace`, `area`, `editedon`) VALUES
...
('cultureKey', 'ru', 'modx-combo-language', 'core', 'language', '2017-03-31 13:25:03'),
...
('upload_maxsize', '104857600', 'textfield', 'core', 'file', '2017-03-31 13:25:03'),
...
--
-- Структура таблицы `new_transport_packages`
--
...
--
-- Структура таблицы `new_transport_providers`
--
...
--
-- Дамп данных таблицы `new_transport_providers`
--
...
--
-- Структура таблицы `new_user_attributes`
--

CREATE TABLE `new_user_attributes` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Дамп данных таблицы `new_user_attributes`
--
...
(1, 1, 'Администратор по умолчанию', 'stan19781@gmail.com', '', '', 0, 0, 0, 1, 0, 1490966735, 0, '2mkm8td6jr3b0p72ee8fpg96m1', 0, 0, '', '', '', '', '', '', '', '', '', NULL);

-- --------------------------------------------------------

--
-- Структура таблицы `new_user_group_roles`
--
...
--
-- Дамп данных таблицы `new_user_group_roles`
--

INSERT INTO `new_user_group_roles` (`id`, `name`, `description`, `authority`) VALUES
(1, 'Member', NULL, 9999),
(2, 'Super User', NULL, 0);
...
--
-- Структура таблицы `new_user_group_settings`
--
...
--
-- Структура таблицы `new_user_messages`
--

CREATE TABLE `new_user_messages` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Структура таблицы `new_user_settings`
--
...
--
-- Структура таблицы `new_workspaces`
--
...
--
-- Дамп данных таблицы `new_workspaces`
--

INSERT INTO `new_workspaces` (`id`, `name`, `path`, `created`, `active`, `attributes`) VALUES
(1, 'Default MODX workspace', '{core_path}', '2017-03-31 16:25:01', 1, NULL);
...
--
-- Индексы таблицы `new_access_actiondom`
--
...
--
-- Индексы таблицы `new_access_actions`
--
...
--
-- Индексы таблицы `new_access_category`
--
...
--
-- Индексы таблицы `new_access_context`
--
...
--
-- Индексы таблицы `new_access_elements`
--
...
--
-- Индексы таблицы `new_access_media_source`
--
...
--
-- Индексы таблицы `new_access_menus`
--
...
--
-- Индексы таблицы `new_access_namespace`
--
...
--
-- Индексы таблицы `new_access_permissions`
--
...
--
-- Индексы таблицы `new_access_policies`
--
...
--
-- Индексы таблицы `new_access_policy_templates`
--
ALTER TABLE `new_access_policy_templates`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `new_access_policy_template_groups`
--
ALTER TABLE `new_access_policy_template_groups`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `new_access_resources`
--
...
--
-- Индексы таблицы `new_access_resource_groups`
--
...
--
-- Индексы таблицы `new_access_templatevars`
--
...
--
-- Индексы таблицы `new_actions_fields`
--
...
--
-- Индексы таблицы `new_active_users`
--
ALTER TABLE `new_active_users`
  ADD PRIMARY KEY (`internalKey`);

--
-- Индексы таблицы `new_categories`
--
...
--
-- Индексы таблицы `new_categories_closure`
--
ALTER TABLE `new_categories_closure`
  ADD PRIMARY KEY (`ancestor`,`descendant`);

--
-- Индексы таблицы `new_class_map`
--
...
--
-- Индексы таблицы `new_content_type`
--
...
--
-- Индексы таблицы `new_context`
--
ALTER TABLE `new_context`
  ADD PRIMARY KEY (`key`),
  ADD KEY `name` (`name`),
  ADD KEY `rank` (`rank`);

--
-- Индексы таблицы `new_context_resource`
--
ALTER TABLE `new_context_resource`
  ADD PRIMARY KEY (`context_key`,`resource`);

--
-- Индексы таблицы `new_context_setting`
--
ALTER TABLE `new_context_setting`
  ADD PRIMARY KEY (`context_key`,`key`);

--
-- Индексы таблицы `new_dashboard`
--
...
--
-- Индексы таблицы `new_dashboard_widget`
--
...
--
-- Индексы таблицы `new_dashboard_widget_placement`
--
ALTER TABLE `new_dashboard_widget_placement`
  ADD PRIMARY KEY (`dashboard`,`widget`),
  ADD KEY `rank` (`rank`);

--
-- Индексы таблицы `new_documentgroup_names`
--
...
--
-- Индексы таблицы `new_document_groups`
--
...
--
-- Индексы таблицы `new_element_property_sets`
--
ALTER TABLE `new_element_property_sets`
  ADD PRIMARY KEY (`element`,`element_class`,`property_set`);

--
-- Индексы таблицы `new_extension_packages`
--
...
--
-- Индексы таблицы `new_fc_profiles`
--
...
--
-- Индексы таблицы `new_fc_profiles_usergroups`
--
ALTER TABLE `new_fc_profiles_usergroups`
  ADD PRIMARY KEY (`usergroup`,`profile`);

--
-- Индексы таблицы `new_fc_sets`
--
...
--
-- Индексы таблицы `new_lexicon_entries`
--
...
--
-- Индексы таблицы `new_manager_log`
--
...
--
-- Индексы таблицы `new_media_sources`
--
...
--
-- Индексы таблицы `new_media_sources_contexts`
--
ALTER TABLE `new_media_sources_contexts`
  ADD PRIMARY KEY (`source`,`context_key`);

--
-- Индексы таблицы `new_media_sources_elements`
--
ALTER TABLE `new_media_sources_elements`
  ADD PRIMARY KEY (`source`,`object`,`object_class`,`context_key`);

--
-- Индексы таблицы `new_membergroup_names`
--
...
--
-- Индексы таблицы `new_member_groups`
--
...
--
-- Индексы таблицы `new_menus`
--
ALTER TABLE `new_menus`
...
--
-- Индексы таблицы `new_namespaces`
--
ALTER TABLE `new_namespaces`
  ADD PRIMARY KEY (`name`);

--
-- Индексы таблицы `new_property_set`
--
...
--
-- Индексы таблицы `new_register_messages`
--
ALTER TABLE `new_register_messages`
...
--
-- Индексы таблицы `new_register_queues`
--
...
--
-- Индексы таблицы `new_register_topics`
--
...
--
-- Индексы таблицы `new_site_content`
--
...
ALTER TABLE `new_site_content` ADD FULLTEXT KEY `content_ft_idx` (`pagetitle`,`longtitle`,`description`,`introtext`,`content`);

--
-- Индексы таблицы `new_site_htmlsnippets`
--
...
--
-- Индексы таблицы `new_site_plugins`
--
...
--
-- Индексы таблицы `new_site_plugin_events`
--
ALTER TABLE `new_site_plugin_events`
  ADD PRIMARY KEY (`pluginid`,`event`),
  ADD KEY `priority` (`priority`);

--
-- Индексы таблицы `new_site_snippets`
--
...
--
-- Индексы таблицы `new_site_templates`
--
...
--
-- Индексы таблицы `new_site_tmplvars`
--
...
--
-- Индексы таблицы `new_site_tmplvar_access`
--
...
--
-- Индексы таблицы `new_site_tmplvar_contentvalues`
--
...
--
-- Индексы таблицы `new_site_tmplvar_templates`
--
ALTER TABLE `new_site_tmplvar_templates`
  ADD PRIMARY KEY (`tmplvarid`,`templateid`);

--
-- Индексы таблицы `new_system_eventnames`
--
ALTER TABLE `new_system_eventnames`
  ADD PRIMARY KEY (`name`);

--
-- Индексы таблицы `new_system_settings`
--
ALTER TABLE `new_system_settings`
  ADD PRIMARY KEY (`key`);

--
-- Индексы таблицы `new_transport_packages`
--
ALTER TABLE `new_transport_packages`
...
--
-- Индексы таблицы `new_transport_providers`
--
...
--
-- Индексы таблицы `new_user_attributes`
--
...
--
-- Индексы таблицы `new_user_group_roles`
--
...
--
-- Индексы таблицы `new_user_group_settings`
--
ALTER TABLE `new_user_group_settings`
  ADD PRIMARY KEY (`group`,`key`);

--
-- Индексы таблицы `new_user_messages`
--
ALTER TABLE `new_user_messages`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `new_user_settings`
--
ALTER TABLE `new_user_settings`
  ADD PRIMARY KEY (`user`,`key`);

--
-- Индексы таблицы `new_workspaces`
--
...
--
-- AUTO_INCREMENT для таблицы `new_access_actiondom`
--
ALTER TABLE `new_access_actiondom`
